...
function pr3(weights::AbstractVector{W}, graph::AbstractGraph{V}, width::W) where {W <: Number, V}
    ...
    stack2 = FixedSizeVector{V}(undef, n)
    stack3 = FixedSizeVector{V}(undef, n)
    stack4 = FixedSizeVector{V}(undef, n)
    stack5 = FixedSizeVector{V}(undef, n)
    index0 = FixedSizeVector{V}(undef, n)
    index1 = FixedSizeVector{V}(undef, n)
    index2 = FixedSizeVector{V}(undef, n)
    index3 = FixedSizeVector{V}(undef, n)
